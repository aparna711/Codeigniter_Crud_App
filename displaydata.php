...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/form_modal.css'); ?>">


    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
   
    <script defer src="./form_script"></script>
</head>
<body>
    <div class="container">
        <!-- PHP Flash Messages -->
        ...
        <div class="header-section">
            ...
            <!-- <a href="<?php // echo base_url('index.php/test/crudApp'); ?>" class="btn-add-new" id="registerModal">
               <i class="fas fa-plus-circle"></i> Register New User
            </a> -->
             <button id="openModal"> <i class="fas fa-plus-circle"> Register New User </i> </button>
        </div>
